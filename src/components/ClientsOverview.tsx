  ...
  return (
    <section className="bg-warm-white">
      ...
      <h3 className="font-bold text-4xl laptop:text-[50px] text-dark-blue">Våra Kunder</h3>
        ...
        <button className="bg-dark-blue self-center tablet:self-start p-3 px-6 rounded-full w-fit h-fit text-sm cursor-pointer shadow-lg text-white font-body hover:scale-110" onClick={() => navigate("/kunder")}>Se alla projekt</button>
      </div>
      </div>
    </section>
  );
