...
export const Testimonial: React.FC<TestimonialProps> = ({
  ...
  return (
    <div
      className={`bg-warm-white shadow-lg rounded-[100px]  p-8 pt-14 pr-12 laptop:pr-24 laptop:pl-20 font-body text-end flex flex-col gap-4 text-xs tablet:text-sm ${position}`}
    >
