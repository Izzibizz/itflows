...
export const BookingCTAComp: React.FC = () => {
  ...
  return (
    <section className={` bg-light-beige h-fit py-20 px-10 text-stone-800 flex flex-col tablet:flex-row gap-6 z-20`}>
      <div className="flex flex-col gap-1 tablet:w-1/2">
      <h3 className="font-wide text-3xl">Boka en tid för konsultation</h3>
      <h4 className="font-header text-xl tablet:w-10/12">Konsultationen är kostnadsfri och det kan vara ditt första steg mot hemsidan du längtat efter.</h4>
