    ...
    return ( 
      <section className="animate-fadeIn  flex flex-col gap-14 laptop:gap-18 font-body">
        ...
        <div className="laptop:w-2/3 flex flex-col gap-2">
          <h3 className="font-header text-dark-blue text-3xl "><span className="font-wide text-4xl ">Därför</span> är branding avgörande för ditt företags framgång</h3>
        ...
        <div className="laptop:w-3/4 laptop:self-end  flex flex-col gap-2 ">
          <h3 className="font-header text-dark-blue text-3xl tablet:text-end ">Du vet vad du gör – men <span className="font-wide text-4xl">vet dina kunder</span>  det?</h3>
        ...
        <div className="laptop:w-1/2  flex flex-col gap-2">
          <h3 className="font-header text-dark-blue text-3xl">Branding <span className="font-wide text-4xl">håller ihop</span> allt – från logotyp till inlägg</h3>
        ...
        <div className="laptop:w-1/2  flex flex-col gap-2">
          <h3 className="font-header text-dark-blue text-3xl">Professionellt intryck bygger <span className="font-wide text-4xl">förtroende</span></h3>
        ...
        <div className="laptop:w-1/2  flex flex-col gap-2">
          <h3 className="font-header text-dark-blue text-3xl"> Det krävs mod för att vara <span className="font-wide text-4xl">tydlig</span> – och det lönar sig</h3>
