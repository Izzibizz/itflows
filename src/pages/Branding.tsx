  ...
  useEffect(() => {
    ...
    return ( 
      <section className="animate-fadeIn ">
        ...
        <h2 className="font-bold text-4xl laptop:text-[40px] text-center text-warm-white ">Bygg ett varumärke som <br className="hidden tablet:block"/>man känner<br className=" tablet:hidden"/> – och minns.</h2>
        </div>
        <MovingCircle/>
      </section>
    )
